...
class FilmControllerTest {
    ...
    void putLike() {
        ...
        assertEquals(filmController.get(1L).getUserLikes().get(0), user.getId(),
    ...
    void deleteLike() {
        ...
        assertEquals(filmController.get(1L).getUserLikes().get(0), user2.getId(),
    ...
    void getMostLikedFilms() {
        ...
        Film film3 = new Film(47L, "Scary Movie 3", "CCC",
                LocalDate.of(2014, 03, 21), 80, new ArrayList<>());
